              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="flex items-center justify-center gap-2.5 py-1.5 border-t border-b border-border/50" data-testid="word-count-strip">
                  ...
                  <span className="text-sm text-muted-foreground leading-none">
                    word{wordsCompleted !== 1 ? "s" : ""} chained
                  </span>
              ...
              <CardContent className="p-6 text-center space-y-4">
                ...
                {!locked && (
                  <div className="flex flex-wrap justify-center gap-2">
                    <Button onClick={() => startGame(variation, level)} className="bg-emerald-500 hover:bg-emerald-600 text-white border-0" data-testid="button-play-again">
                      Play Again
                    </Button>
