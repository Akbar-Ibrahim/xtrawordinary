...
export interface PublicProfile {
  user: { id: number; username: string; name: string; avatarUrl: string | null; createdAt: string; isPremium: boolean };
  stats: UserGameStats[];
...
export type FriendEntry = { id: number; friendUser: { id: number; username: string; name: string; avatarUrl: string | null } };
