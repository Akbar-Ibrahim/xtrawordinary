...
export const MAX_COMBINATIONS_PER_BASE_WORD = 50;
...
const EXCLUDED_THREE_LETTER_WORDS = new Set<string>([
  ...
  "BLO", "BLS", "BNF", "BOC", "BOE", "BOH", "BOL", "BOM", "BON", "BOO",
  "BOP", "BOR", "BOS", "BOT", "BOW", "BOX", "BOY", "BPI", "BPS", "BPT",
  "BRL", "BRR", "BSF", "BSH", "BTL", "BTU", "BUB", "BUG",
  "BUL", "BUR", "BUZ", "BVT", "BXS", 
  ...
  "CRS", "CRU", "CRY", "CSC", "CSI", "CSK", "CSP", "CST", "CSW", "CTE",
  ...
  "DFT", "DHA", "DHU", "DIA", "DIB", "DID", "DIE", "DIF", "DIG", "DIL",
  "DIN", "DIR", "DIS", "DIT", "DIV", "DIX", "DKG", "DKL",
  "DKM", "DKS", "DLR", "DOA", "DOB", "DOC", "DOD", "DOW", 
  "DOL", "DOM", "DON", "DOO", "DOP", "DOR", "DOS", "DOW", "DOZ",
  "DPT", "DRY", "DSP", "DSR", "DTD", "DUC", 
  "DUI", "DUM", "DUN", "DUO", "DUP", "DUR", "DUX", "DWT", "DYE", "DYN",
  "DYS", "DZO", "EAD", "EAM", "EAN", "EAR", "EAT", "EAU", "EBB", "ECB",
  "ECU", "EDH", "EDO", "EDP", "EDS", "EEL", "EEN", "EER", "EFF",
  "EFL", "EFS", "EFT", "EIR", "EKE", "ELA", "ELB", "ELD",
  "ELF", "ELI", "ELK", "ELL", "ELM", "ELS", "ELT", "EME", "EMF", "EMM",
  "EMP", "EMS", "EMU", "ENC", "ENG", "ENL", "ENS", "ENV", "EOF",
  "EOM", "EOS", "EPA", "EPI", "ERA", "ERD", "ERE", "ERF", "ERG",
  "ERK", "ERR", "ERS", "ESC", "ESD", "ESE", "ESP", "ESQ", "ESS",
  "EST", "ESU", "ETA", "ETC", "ETH", "ETY", "EVA", "EVG", "EWE",
  "EXP", "EXR", "EXT", "EYL", "EYN", "EYR", "FAB", "FAC", "FAD",
  "FAE", "FAG", "FAM", "FAN", "FAQ", "FAS", "FAT", "FAY",
  "FBI", "FCP", "FCS", "FCY", "FEC", "FED", "FEE", "FEH", "FEI", "FEM",
  "FEN", "FER", "FET", "FEU", "FEW", "FEY", "FEZ", "FFA", "FGN", "FIB",
  "FID", "FIE", "FIL", "FIP", "FIR", "FIZ",
  "FLB", "FLD", "FLL", "FLO", "FLU", "FMT", "FOB", "FOD", "FOE",
  "FOH", "FOL", "FON", "FOO", "FOP", "FOT", "FOU", "FOW",
  "FOY", "FPM", "FPS", "FRA", "FRO", "FRS", "FRT", "FRY", "FTH",
  "FUB", "FUD", "FUG", "FUM", "FUT", "FWD", 
  "GAE", "GAG", "GAJ", "GAL", "GAM", "GAN", "GAR", 
  "GAU", "GAW", "GAY", "GAZ", "GCD", "GDS", "GEB", "GED", "GEE", "GEL",
  "GEN", "GER", "GES", "GEY", "GEZ", "GGR", "GHI",
  "GIB", "GID", "GIE", "GIF", "GIG", "GIL", "GIM", "GIO", "GIP",
  "GIS", "GIT", "GLB", "GLD", "GLT", "GNS", "GNU", "GOA", "GOB", "GOD",
  ...
  "GYE", "GYN", "GYP", "HAB", "HAE", "HAF", "HAG", "HAH", "HAJ",
  "HAK", "HAL", "HAN", "HAO", "HAU", "HAV",
  "HCB", "HCF", "HCL", "HED", "HEE", "HEH", "HEI", "HEL",
  "HEO", "HEP", "HES", "HET", "HEW", 
  "HGT", "HHD", "HIA", "HIC", "HIE", "HIN", "HIR",
  "HLD", "HNY", "HOB", "HOC", "HOD", "HOI",
  "HOL", "HON", "HOO", "HOR", "HOX", "HOY",
  "HRS", "HSI", "HTS", "HUD", "HUH", "HUI", "HUK",
  "HUN", "HUP", "HUT", "HVY", "HWA", "HWT", "HWY", "HYD", "HYE",
  "HYP", "IAN", "IAO", "IBA", "IBM", "IBO", "ICE", "ICH", "ICY", "IDA",
  ...
  "IVY", "IWA", "IYO", "JAB", "JAD", "JAG", "JAH", "JAI", "JAK", "JAM",
  "JAN", "JAP", "JAR", "JAT", "JAW", "JAY", "JCL", "JCT", "JED", "JEE",
  "JEF", "JEG", "JEM", "JEN", "JER", "JEU", "JEW", "JIB", "JIG",
...
"POY", "POZ", "PPA", "PPB", "PPD", "PPH", "PPI", "PPL",
  ...
  "RUS", "RUX", "RWD", "RWY", "RYA",
  "SAA", "SAB", "SAC", "SAE", "SAH", "SAI", "SAJ",
  "SAK", "SAL", "SAM", "SAN", "SAO", "SAR", "SAU", "SAV",
  "SCF", "SCH", "SCI", "SCR", "SCT", "SDS", "SEA",
  "SEC", "SED", "SEG", "SEI", "SEL", "SEM", "SEN", "SEP", "SEQ",
  "SER", "SEY", "SFM", "SFZ", "SGD", "SHA", 
  "SHH", "SHI", "SHO", "SHP", "SHR", "SHT", "SHU", "SIA", "SIB",
  "SIC", "SID", "SIE", "SIG", "SIL", "SIM", "SIS",
  "SIT", "SIX", "SKI", "SKY", "SLA", "SLD", "SLT", "SMA", "SML",
  "SNY", "SOC", "SOD", "SOE", "SOH", "SOK", "SOL", 
  "SOS", "SOU", "SOV", "SOX", "SPL",
  ...
  "VAV", "VAW", "VAX", "VEE", "VEG", "VEI", "VEL", "VER", "VET", "VEX",
  ...
  "YAD", "YAH", "YAK", "YAN", "YAO", "YAR", "YAS", "YAT",
  "YAW", "YAY", "YDS", "YEA", "YED", "YEE", "YEH",  "YEO", 
  "YER", "YEW", "YEX", "YEZ", "YID", "YIN", "YIP", "YIS",
  "YOB", "YOD", "YOE", "YOI", "YOK", "YOM", "YON", "YOR", "YOT", 
  "YOW", "YOX", "YOY", "YRS", "YUG", "YUH", "YUK", "YUM", "YUN", "YUP",
  "YUS", "ZAC", "ZAD", "ZAG", "ZAK", "ZAN", "ZAR", "ZAT", "ZAX",
  "ZEA", "ZED", "ZEE", "ZEK", "ZEL", "ZEP", "ZER", "ZHO", "ZIG",
  "ZOA", "ZOD", 
]);
