...
const wordLadderPuzzles: WordLadderPuzzle[] = [
  {
    start: "COAT",
    target: "BOOT",
    par: 2,
...
const progressiveRevealWords: ProgressiveRevealWord[] = [
  ...
  { word: "HARP", subcategory: "String instrument" },
  { word: "RUBY", subcategory: "Red gemstone" },
  { word: "MOTH", subcategory: "Night insect" },
  { word: "SAGE", subcategory: "Cooking herb" },
  { word: "LAVA", subcategory: "Volcanic material" },
  { word: "DUNE", subcategory: "Sand formation" },
  { word: "WREN", subcategory: "Small bird" },
  { word: "PLUM", subcategory: "Purple fruit" },
  { word: "FERN", subcategory: "Leafy plant" },
  { word: "IRON", subcategory: "Common metal" },
  { word: "LYNX", subcategory: "Wild cat" },
  { word: "OPAL", subcategory: "Iridescent gemstone" },
  { word: "CLAY", subcategory: "Pottery material" },
  { word: "KIWI", subcategory: "Fuzzy fruit" },
  { word: "BOLT", subcategory: "Fastener" },
  { word: "GUST", subcategory: "Wind burst" },
  { word: "VASE", subcategory: "Flower container" },
  { word: "REEF", subcategory: "Ocean formation" },
  { word: "PEAR", subcategory: "Tree fruit" },
  // 5-letter words
  { word: "CRANE", subcategory: "Wading bird" },
  { word: "MAPLE", subcategory: "Deciduous tree" },
  { word: "TOPAZ", subcategory: "Yellow gemstone" },
  { word: "GOOSE", subcategory: "Waterfowl" },
  { word: "BASIL", subcategory: "Italian herb" },
  { word: "CEDAR", subcategory: "Evergreen tree" },
  { word: "CORAL", subcategory: "Marine organism" },
  { word: "FLUTE", subcategory: "Woodwind instrument" },
  { word: "LEMON", subcategory: "Citrus fruit" },
  { word: "STEEL", subcategory: "Construction metal" },
  { word: "MOOSE", subcategory: "Large deer" },
  { word: "PEACH", subcategory: "Stone fruit" },
  { word: "IVORY", subcategory: "Shade of white" },
  { word: "THYME", subcategory: "Savory herb" },
  { word: "ROBIN", subcategory: "Garden bird" },
  ...
  { word: "LILAC", subcategory: "Spring flower" },
  // 6-letter words
  ...
  { word: "KANGAROO", subcategory: "Jumping marsupial" },
  { word: "MUSHROOM", subcategory: "Edible fungus" },
  { word: "LAVENDER", subcategory: "Purple flower" },
  { word: "SQUIRREL", subcategory: "Tree-climbing rodent" },
  { word: "MACARONI", subcategory: "Pasta shape" },
  { word: "MANDOLIN", subcategory: "Plucked string instrument" },
  { word: "SCORPION", subcategory: "Desert arachnid" },
  { word: "OBSIDIAN", subcategory: "Volcanic glass" },
  { word: "FLAMINGO", subcategory: "Pink wading bird" },
  { word: "CARDINAL", subcategory: "Red songbird" },
  { word: "BROCCOLI", subcategory: "Green vegetable" },
  { word: "AMETHYST", subcategory: "Purple gemstone" },
  { word: "HEDGEHOG", subcategory: "Spiny mammal" },
  { word: "JALAPENO", subcategory: "Hot pepper" },
  // 9-letter words
  { word: "ALLIGATOR", subcategory: "Swamp reptile" },
  { word: "CHAMELEON", subcategory: "Color-changing lizard" },
  { word: "DANDELION", subcategory: "Yellow wildflower" },
  { word: "GLADIATOR", subcategory: "Roman fighter" },
  { word: "MAELSTROM", subcategory: "Powerful whirlpool" },
  { word: "NIGHTHAWK", subcategory: "Nocturnal bird" },
  { word: "PORCELAIN", subcategory: "Fine ceramic" },
  { word: "RASPBERRY", subcategory: "Red berry" },
  { word: "SUNFLOWER", subcategory: "Tall garden flower" },
  { word: "TURQUOISE", subcategory: "Blue-green stone" },
  { word: "WOLVERINE", subcategory: "Fierce weasel" },
  { word: "PORCUPINE", subcategory: "Quill-covered rodent" },
  { word: "BLUEBERRY", subcategory: "Small dark fruit" },
  { word: "CRANBERRY", subcategory: "Tart red berry" },
  { word: "HARMONICA", subcategory: "Mouth organ" },
  { word: "SWORDFISH", subcategory: "Long-nosed fish" },
  { word: "BUCKTHORN", subcategory: "Thorny shrub" },
  { word: "LIMESTONE", subcategory: "Sedimentary rock" },
  { word: "GLADIOLUS", subcategory: "Sword-shaped flower" },
  { word: "ARTICHOKE", subcategory: "Thistle vegetable" },
  // 10-letter words
  { word: "CHANDELIER", subcategory: "Ceiling light fixture" },
  { word: "RHINOCEROS", subcategory: "Horned mammal" },
  { word: "STRAWBERRY", subcategory: "Red garden fruit" },
  { word: "EUCALYPTUS", subcategory: "Australian tree" },
  { word: "PEPPERMINT", subcategory: "Cooling herb" },
  { word: "WOODPECKER", subcategory: "Tree-drilling bird" },
  { word: "GRAPEFRUIT", subcategory: "Bitter citrus" },
  { word: "COPPERHEAD", subcategory: "Venomous snake" },
  { word: "WATERMELON", subcategory: "Summer fruit" },
  { word: "CANTALOUPE", subcategory: "Orange melon" },
  { word: "CHINCHILLA", subcategory: "Soft-furred rodent" },
  { word: "SNAPDRAGON", subcategory: "Garden flower" },
  { word: "CLEMENTINE", subcategory: "Small citrus" },
  { word: "TAMBOURINE", subcategory: "Percussion instrument" },
  { word: "BLOODHOUND", subcategory: "Tracking dog breed" },
  { word: "TOURMALINE", subcategory: "Multicolored gemstone" },
  { word: "BLACKBERRY", subcategory: "Bramble fruit" },
  { word: "MANGOSTEEN", subcategory: "Tropical fruit" },
  { word: "BUTTERMILK", subcategory: "Fermented dairy" },
  { word: "KINGFISHER", subcategory: "Diving bird" },
];
