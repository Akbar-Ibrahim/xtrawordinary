...
export const gamesData: Game[] = [
  ...
  },
  {
    ...
    longDescription: "A lipogram challenge! You're shown a set of forbidden letters and must submit valid English words that contain none of them — all within 90 seconds. Six difficulty tiers let you choose how many letters to dodge: from a single banned letter up to five, or flip it to Advanced for a randomised constraint every game. Longer words score more points, and 7+ letter words earn a bonus.",
    rules: [
      "A set of forbidden letters is displayed prominently — your words must not contain any of them",
      "Type any valid English word (3+ letters) that avoids all forbidden letters, then press Enter",
      ...
      "You have 90 seconds — submit as many valid words as possible",
