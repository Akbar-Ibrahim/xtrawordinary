...
export const wordStackPuzzles: WordStackPuzzle[] = [
  { targetWord: "PERSONAL", startWord: "OR" },
  { targetWord: "STARTING", startWord: "AT" },
  { targetWord: "STRANGER", startWord: "AN" },
  { targetWord: "CREATING", startWord: "AT" },
  { targetWord: "PLEASANT", startWord: "AS" },
  { targetWord: "TEACHING", startWord: "AT" },
  { targetWord: "REACHING", startWord: "IN" },
  { targetWord: "BREAKING", startWord: "IN" },
  { targetWord: "TREATING", startWord: "AT" },
  { targetWord: "CLEANING", startWord: "AN" },
];
...
export const progressiveRevealWords: ProgressiveRevealWord[] = [
  { word: "ELEPHANT", subcategory: "Large land animal", hint: "Large land animal" },
  { word: "MERCURY", subcategory: "Planet in our solar system", hint: "Planet in our solar system" },
  { word: "CINNAMON", subcategory: "Baking spice", hint: "Baking spice" },
  { word: "TORNADO", subcategory: "Severe weather event", hint: "Severe weather event" },
  { word: "PYRAMID", subcategory: "Ancient structure", hint: "Ancient structure" },
  { word: "DOLPHIN", subcategory: "Ocean mammal", hint: "Ocean mammal" },
  { word: "VOLCANO", subcategory: "Geological formation", hint: "Geological formation" },
  { word: "HARVEST", subcategory: "Farming activity", hint: "Farming activity" },
  { word: "COMPASS", subcategory: "Navigation tool", hint: "Navigation tool" },
  { word: "LANTERN", subcategory: "Light source", hint: "Light source" },
  { word: "CRIMSON", subcategory: "Shade of red", hint: "Shade of red" },
  { word: "WHISTLE", subcategory: "Sound-making object", hint: "Sound-making object" },
  { word: "GLACIER", subcategory: "Ice formation", hint: "Ice formation" },
  { word: "CABINET", subcategory: "Household furniture", hint: "Household furniture" },
  { word: "SPARROW", subcategory: "Common bird", hint: "Common bird" },
  { word: "DIAMOND", subcategory: "Precious gemstone", hint: "Precious gemstone" },
  { word: "MUSTARD", subcategory: "Condiment", hint: "Condiment" },
  { word: "CHARCOAL", subcategory: "Grilling fuel", hint: "Grilling fuel" },
  { word: "BLANKET", subcategory: "Bedroom item", hint: "Bedroom item" },
  { word: "PENGUIN", subcategory: "Flightless bird", hint: "Flightless bird" },
  { word: "SAPPHIRE", subcategory: "Blue gemstone", hint: "Blue gemstone" },
  { word: "HAMMOCK", subcategory: "Outdoor relaxation", hint: "Outdoor relaxation" },
  { word: "TRUMPET", subcategory: "Brass instrument", hint: "Brass instrument" },
  { word: "LEOPARD", subcategory: "Big cat", hint: "Big cat" },
  { word: "AVOCADO", subcategory: "Green fruit", hint: "Green fruit" },
  { word: "BLIZZARD", subcategory: "Winter storm", hint: "Winter storm" },
  { word: "CHANDELIER", subcategory: "Ceiling light fixture", hint: "Ceiling light fixture" },
  { word: "JASMINE", subcategory: "Fragrant flower", hint: "Fragrant flower" },
  { word: "SERPENT", subcategory: "Reptile", hint: "Reptile" },
  { word: "TITANIUM", subcategory: "Strong metal", hint: "Strong metal" },
];
...
// ── Word Extension fallback puzzles ──────────────────────────────────────────
// Each row: player sees shownWord and must type a longer word whose letter
// multiset contains all of shownWord's letters plus (lettersToAdd) more.
export const wordExtensionFallbackPuzzles: Record<number, Array<{ shownWord: string; validAnswers: string[] }>> = {
  1: [
    { shownWord: "TRAIN", validAnswers: ["STRAIN", "TRAINS"] },
    { shownWord: "REACH", validAnswers: ["BREACH", "PREACH"] },
    { shownWord: "LOWER", validAnswers: ["FLOWER", "BLOWER", "GLOWER"] },
    { shownWord: "RAISE", validAnswers: ["PRAISE", "RAISES"] },
    { shownWord: "LAYER", validAnswers: ["PLAYER", "SLAYER"] },
    { shownWord: "HEART", validAnswers: ["HEARTS"] },
    { shownWord: "LIGHT", validAnswers: ["BLIGHT", "FLIGHT", "SLIGHT", "PLIGHT"] },
    { shownWord: "RANGE", validAnswers: ["ORANGE"] },
    { shownWord: "LEASE", validAnswers: ["PLEASE"] },
    { shownWord: "STONE", validAnswers: ["STONES", "ATONES"] },
  ],
  2: [
    { shownWord: "TRAIN", validAnswers: ["TRAINER"] },
    { shownWord: "RANGE", validAnswers: ["ORANGES"] },
    { shownWord: "LOWER", validAnswers: ["FLOWERS"] },
    { shownWord: "RAISE", validAnswers: ["PRAISES"] },
    { shownWord: "LAYER", validAnswers: ["PLAYERS"] },
    { shownWord: "HEART", validAnswers: ["THREATS"] },
    { shownWord: "LIGHT", validAnswers: ["FLIGHTS"] },
    { shownWord: "LEASE", validAnswers: ["PLEASED"] },
    { shownWord: "STONE", validAnswers: ["CONTEST"] },
    { shownWord: "STARE", validAnswers: ["EASTERN", "ROASTED", "TOASTER"] },
  ],
  3: [
    { shownWord: "TRAIN", validAnswers: ["STRAINER"] },
    { shownWord: "RANGE", validAnswers: ["STRANGER"] },
    { shownWord: "HEART", validAnswers: ["FEATHERS"] },
    { shownWord: "LOWER", validAnswers: ["OVERFLOW"] },
    { shownWord: "RAISE", validAnswers: ["APPRAISE"] },
    { shownWord: "STONE", validAnswers: ["CONTESTS"] },
    { shownWord: "LIGHT", validAnswers: ["DELIGHTS"] },
    { shownWord: "LEASE", validAnswers: ["RELEASED"] },
    { shownWord: "LAYER", validAnswers: ["REPLAYED"] },
    { shownWord: "STARE", validAnswers: ["RESTATED"] },
  ],
  4: [
    { shownWord: "TRAIN", validAnswers: ["RESTRAINT"] },
    { shownWord: "RANGE", validAnswers: ["STRANGERS"] },
    { shownWord: "LOWER", validAnswers: ["OVERFLOWS"] },
    { shownWord: "HEART", validAnswers: ["FEATHERED"] },
    { shownWord: "STONE", validAnswers: ["MILESTONE"] },
    { shownWord: "LIGHT", validAnswers: ["HIGHLIGHT"] },
    { shownWord: "LEASE", validAnswers: ["RELEASING"] },
    { shownWord: "RAISE", validAnswers: ["APPRAISES"] },
    { shownWord: "STARE", validAnswers: ["STAIRCASE"] },
    { shownWord: "LAYER", validAnswers: ["OVERPLAYS"] },
  ],
};
...
export const gamesData: Game[] = [
  ...
  },
  {
    ...
    description: "Find isogram words with no repeated letters that also contain the required letters shown!",
    longDescription: "Two constraints in one: every word you enter must be an isogram (no letter appears more than once), AND it must contain a set of required letters shown on screen. Required letters scale with difficulty: 1 letter for 3-letter challenges, 2 for 4–6 letters, and 3 for the longest challenges. You get one reroll per session if the required letters don't suit you. How many isograms can you find before time runs out?",
    rules: [
      "Every word must be an isogram: no letter can appear more than once",
      "Your word must also contain all of the required letters shown on screen",
      "Required letters: 1 for Challenge 3, 2 for Challenges 4–6, 3 for Challenges 7–9",
      "You get one free reroll per session to change your required letters",
      "Words must be valid English words",
      "Score points based on word length. Longer isograms earn more!"
    ],
    difficulty: "medium",
    estimatedTime: "5-8 min",
    icon: "Fingerprint",
  ...
  },
  {
    ...
    rules: [
      ...
      "Exactly two letter positions must differ between consecutive words; no rearranging",
      "You have 90 seconds. Chain as many words as possible.",
      "Each word in the chain must be a real English word",
      "Words already used in your chain cannot be reused",
      "Score = number of words you chain beyond the starting word"
  ...
  },
  {
    ...
    rules: [
      ...
      "Blitz: Enter as many shell words as you can. Classic gives 90 seconds; Survival resets an 8-second clock per word",
      "Wrapper: Given an inner word, find outer shells. Classic finds all in 2 min; Survival gives 8 seconds per wrapper",
  ...
  },
  {
    ...
    description: "Strip the first two and last two letters to reveal the hidden inner word, for a deeper challenge!",
    ...
    rules: [
      ...
      "Blitz: Enter as many deep shell words as you can. Classic gives 90 seconds; Survival resets an 8-second clock per word",
      "Wrapper: Given an inner word, find outer shells. Classic finds all in 2 min; Survival gives 8 seconds per wrapper",
  ...
  },
  {
    ...
    longDescription: "Start with a short seed word and grow it step by step: insert one letter anywhere (without rearranging) to form a new valid word, then keep building from there. For example: AM → AIM → AIMS → MAIMS. Every step must be exactly one letter longer than the previous. How deep can your chain go?",
    rules: [
      "You are given a short seed word (2–4 letters)",
      ...
      "Example: AM → AIM → AIMS → MAIMS",
      "Scoring: 10 pts base + 5 pts per letter added beyond seed length",
      "e.g. seed AM (2 letters) → AIM (3) = 10+5×1 = 15 pts; AIM → AIMS (4) = 10+5×2 = 20 pts",
  ...
  },
  {
    ...
    slug: "letter-dodge",
    name: "Letter Dodge",
    description: "Type valid words that avoid the forbidden letters. The more you ban, the harder it gets!",
    longDescription: "A lipogram challenge! You're shown a set of forbidden letters and must submit valid English words (4+ letters) that contain none of them. Classic mode gives 90 seconds; Survival mode resets an 8-second clock on every correct word. Six difficulty tiers let you choose how many letters to dodge: from a single banned letter up to five, or flip it to Advanced for a randomised constraint every game. Longer words score more points, and 7+ letter words earn a bonus.",
    rules: [
      "A set of forbidden letters is displayed prominently. Your words must not contain any of them.",
      "Type any valid English word (4+ letters) that avoids all forbidden letters, then press Enter",
      "Words containing a forbidden letter are rejected immediately, even before server validation",
      "A live warning appears as you type if your current input contains a forbidden letter",
  ...
  },
  {
    ...
    slug: "word-extension",
    name: "Word Extension",
    description: "Find a longer word that contains all of the base word's letters plus a set number of extras.",
    longDescription: "You are shown a base word. Find a longer word that contains all of its letters plus a set number of extras. The letters can appear in any order; every letter from the base word just needs to be present in your answer. Choose your difficulty: +1 letter (Easy) through +4 letters (Expert). Multiple valid answers are possible!",
    rules: [
      "You are shown a base word",
      "Type a longer word that contains ALL of the base word's letters, plus the required number of extra letters",
      "Letter order doesn't matter; it's about letter counts (multisets)",
      "Multiple correct answers are possible",
      "Wrong answers show an error; correct ones advance to the next word",
  ...
  },
  {
    ...
    rules: [
      ...
      "Classic: 2 minutes to find as many as possible. 'X of Y found' is shown.",
