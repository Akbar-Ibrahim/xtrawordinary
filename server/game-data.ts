...
export const ladderRushStartWords: Record<number, string[]> = {
  ...
  5: [
    ...
    "OTHER", "OUTER", "OWNED", "OWNER", "OYSTER", "PANEL", "PAPER", "PARTY", "PATCH",
    "PAUSE", "PEACE", "PEARL", "PERCH", "PHASE", "PILOT", "PINCH", "PITCH", "PLACE",
    "PLAIN", "PLANE", "PLANK", "PLANT", "PLATE", "PLEAD", "PLUMB", "PLUME", "PLUNGE",
  ...
  6: [
    ...
    "LISTEN", "LIVELY", "LONGER", "LOSING", "LOYAL", "LUSTRE", "MANAGE", "MANNER",
    "MARKED", "MARKET", "MARVEL", "MASTER", "MATTER", "MENTAL", "MIDDLE", "MIRROR",
    "MODERN", "MOMENT", "MORTAL", "MOTHER", "MOTIVE", "MURDER", "MUSCLE", "MUTUAL",
    "NARROW", "NATURE", "NEEDED", "NEGATE", "NORMAL", "NOTICE", "NOURISH", "OBJECT",
    "OBLONG", "OBTAIN", "OFFICE", "ORIGIN", "ORIGIN", "PALACE", "PATENT", "PATROL",
    "PATTERN", "PERSON", "PHRASE", "PLANET", "PLAYER", "PLEASE", "PLENTY", "POCKET",
